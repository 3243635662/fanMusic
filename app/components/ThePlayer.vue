    ...
    >
      ...
      <div class="flex items-center gap-4 min-w-[200px] flex-1">
        <div class="w-14 h-14 rounded-lg overflow-hidden shadow-lg bg-white/5 relative group/art">
           <img 
            v-if="musicStore.currentTrack?.image"
           ...
           <div v-else class="w-full h-full flex items-center justify-center">
             <UIcon name="i-lucide-music" class="w-6 h-6 text-white/20" />
           </div>
        </div>
      ...
      <div class="flex items-center gap-6 shrink-0">
        <button class="text-white/40 hover:text-white transition-colors">
          <UIcon name="i-lucide-skip-back" class="w-5 h-5 fill-current" />
        </button>
        ...
        <button class="text-white/40 hover:text-white transition-colors">
          <UIcon name="i-lucide-skip-forward" class="w-5 h-5 fill-current" />
        </button>
      </div>
